...
import { Container, H2, H3, Content, Text, Icon, Card, Item, CardItem, Right, Thumbnail, Body, List, ListItem} from 'native-base';
import Reactotron from 'reactotron-react-native';
import Hr from 'react-native-hr';

export default class Piutang extends Component {
    constructor(props){
        super(props)
        this.state={}
    }
